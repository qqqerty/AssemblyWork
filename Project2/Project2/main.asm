...
input_msg1 byte "Enter first number: ", 0
input_msg2 byte "Enter second number: ", 0
...
main proc
     ;第一个数的处理
	 invoke printf, offset input_msg1
	 ...
	 ;第二个数
	 invoke printf, offset input_msg2
	 ...
	 invoke printf, offset result_msg
